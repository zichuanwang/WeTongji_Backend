...
Activity.create(:title => '校园十大歌手', :channel => c2, :organizer => org1, :sub_organizer => sorg1, :description => '校园十大歌手决赛', :begin => '2012.04.30 18:30', :end => '2012.04.30 20:30', :location => '大礼堂', :follow => 1000, :like => 400, :hot => 4000)
Activity.create(:title => '爱拍同济摄影大赛', :channel => c1, :organizer => org2, :sub_organizer => sorg2, :description => '校友摄影协会成立仪式暨第一次活动爱拍同济摄影大赛', :begin => '2012.05.19 8:30', :end => '2012.05.20 20:30', :location => '综合楼', :follow => 357, :like => 789, :hot => 1040)
Activity.create(:title => '同舟讲坛《走进你的心里》主讲人:裴刚', :channel => c3, :organizer => org1, :sub_organizer => sorg3, :description => '裴钢校长给我们做题为《走近你的心里》的学术讲座，相约星期四！', :begin => '2012.04.26 19:00', :end => '2012.04.26 21:00', :location => '逸夫楼2楼报告厅', :follow => 788, :like => 289, :hot => 3002)